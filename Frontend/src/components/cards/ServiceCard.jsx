...
const ServiceCard = ({service, index}) => {
  ...
  return (
    ...
    >
        ...
        {/* Glow effect - placed ABOVE background but BELOW content */}
        <div
          className={`pointer-events-none blur-2xl rounded-full bg-gradient-to-r from-blue-500 via-indigo-500 to-purple-500 w-[300px] h-[300px] absolute z-10 transition-opacity duration-500 ${visible ? 'opacity-70' : 'opacity-0'}`}
